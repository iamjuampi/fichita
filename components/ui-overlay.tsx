...
const generateMockComments = (gameId: string): Comment[] => {
    ...
    tetris: [
      {
        ...
        text: "Can't stop playing! So addictive 🧩",
      },
      {
        username: "$block_builder",
        text: "Got to level 15! Anyone beat that?",
      },
      {
        username: "$tetris_pro",
        text: "The line clearing animation is so satisfying",
      },
    ],
    "space-invaders": [
      {
        username: "$space_cadet",
        text: "Defending Earth one alien at a time! 👾",
      },
  ...
  const templates =
    commentTemplates[gameId as keyof typeof commentTemplates] || [];
    ...
    <div className="fixed inset-0 pointer-events-none z-30">
      ...
      <div className="absolute right-4 bottom-20 flex flex-col items-center space-y-6 pointer-events-auto">
        ...
        <div className="flex flex-col items-center space-y-2">
          ...
          <span className="text-xs text-white font-medium text-shadow-soft">
            {formatCount(likes)}
          </span>
        </div>
      ...
      <div className="absolute bottom-4 left-4 right-20 text-white pointer-events-auto">
        <div className="space-y-2">
          <div className="flex items-center space-x-2">
            ...
            <span className="font-semibold text-sm text-shadow-soft">
          ...
          <p className="text-sm leading-relaxed max-w-xs text-shadow-soft">
            {currentGame.caption}
          </p>
          ...
          {fichitasEarned > 0 && (
            <div className="flex items-center space-x-2">
              <span className="text-xs text-accent font-semibold text-shadow-soft">
                +{fichitasEarned} $fichitas
              </span>
